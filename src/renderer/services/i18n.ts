...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentsSubtitle: '按行业分类浏览专家，召唤他们为你服务',
    agentsCenterTitle: '专家中心',
    agentsCategoryAll: '全部',
    agentsHireButton: '聘请',
    agentsHired: '已聘请',
  ...
  en: {
    ...
    agentsSubtitle: 'Browse experts by industry and summon them to serve you',
    agentsCenterTitle: 'Expert Center',
    agentsCategoryAll: 'All',
    agentsHireButton: 'Hire',
    agentsHired: 'Hired',
    presetAgents: 'Preset Agents',
    myCustomAgents: 'My Custom Agents',
    createNewAgent: 'New Expert',
